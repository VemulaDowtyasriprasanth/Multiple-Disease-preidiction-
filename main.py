...
diabetes_model = pickle.load(
    open(r'C:\Users\Merlyn\Documents\Multidisease\saved_models\diabetes_model.sav', 'rb'))
...
def load_sidebar_css():
    with open('sidebar.css') as f:
        st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)

# Load the CSS file for the main content area
def load_content_css():
    with open('style.css') as f:
        st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)

# Load the CSS files for the sidebar and main content area
load_sidebar_css()
load_content_css()
